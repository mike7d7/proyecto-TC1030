...
int main() {
  ...
  Gamematch *std1 = new Standard("R U 4 me - Myself", 7.1, 251, 34, 0, 3, 322);
  ...
  Gamematch *mania1 = new Mania("Galaxy Collapse - DellyK", 8.66, 2666, 89, 10,
                                84, 2700, 7, 5907, 438);
  // https://osu.ppy.sh/scores/6169855412
  Gamematch *mania2 = new Mania("DEUX EX MAXHINA - Gaboelmascapo27", 6.42, 867,
                                37, 11, 39, 291, 4, 1714, 159);
